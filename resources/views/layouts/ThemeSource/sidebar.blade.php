...
<!-- Page Sidebar -->
 ...
 <li>
                    <a href="#" class="menu-dropdown">
                        <i class="menu-icon fa fa-users"></i>
                        <span class="menu-text"> Serivses Management </span>
                        <i class="menu-expand"></i>
                    </a>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="{{url('SystemAdministrator/CreateSerivses')}}">
                                <span class="menu-text">Create Serivses</span>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <li>
                    <a href="#" class="menu-dropdown">
                        <i class="menu-icon fa fa-delicious"></i>
                        <span class="menu-text"> Password  Management </span>
                        <i class="menu-expand"></i>
                    </a>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="{{url('Branch/ChangePassword')}}">
