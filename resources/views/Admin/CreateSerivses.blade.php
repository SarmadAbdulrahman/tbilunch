    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Create New Servise</li>
            </ul>
        </div>
        <!-- /Page Breadcrumb -->
        <!-- Page Header -->
                            ...
                            <div class="widget flat radius-bordered">
                                ...
                                <div class="widget-body">
                                    <div id="registration-form">
                                        <form role="form" method="post" id="cc" action="{{url('SystemAdministrator/StoreServise')}}">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" class="form-control" name="ServiseName" id="ServiseName" placeholder="ServiseName">
