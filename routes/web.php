...
// CreateSerivses   StoreServise
        ...
        Route::get('/CreateSerivses','Admin\AdminController@CreateSerivses');
        Route::post('/StoreServise','Admin\AdminController@StoreServise');
});
...
Route::group(['prefix'=>'Branch','middleware' => ['role:Branch']], function () {
  // Createappointment  StoreAppointment  Showappointment  ChangePassword  StorePassword
    ...
    Route::post('/StoreAction','Branch\BranchController@StoreAction');
    Route::get('/ChangePassword','Branch\BranchController@ChangePassword');
